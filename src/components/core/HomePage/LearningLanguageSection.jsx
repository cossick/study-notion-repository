    ...
    <div className=' mt-[130px]'>
        <div className=' flex flex-col gap-5 items-center'>
            ...
            <div className=' text-center text-richblack-600 mx-auto text-base mt-3 font-medium w-[50%]'>
                Using spin making learning multiple languages easy with 20 realisitic voice-over, progress tracking 
            </div>
            <div className=' flex flex-row items-center justify-center mt-5'>
                ...
                <img src={plan_your_lesson} className="object-contain -ml-32"/>
            </div>
